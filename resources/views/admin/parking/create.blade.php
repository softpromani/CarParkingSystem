                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-control" id="user_id" name="user_id">
                                ...
                                <option value="{{ $user->id }}" {{ isset($editparking) && $editparking->user_id == $user->id ? 'selected' : '' }}>
                                    {{ $user->name ?? '' }}
                                </option>
                        ...
                        <div class="col-md-4">
                            ...
                            value="{{ old('name', $editparking->name ?? '') }}"
                            required />
                        </div>
                        <div class="col-md-4">
                            <x-input-box name="image" type="file" label="Image" placeholder="Upload image" required />
                        ...
                        <div class="col-md-4 mt-2">
                            <x-input-box name="motorcycle_count" label="Motorcycle Count" placeholder="Enter motorcycle count"
                        ...
                        <div class="col-md-4 mt-2">
                            <x-input-box name="motorcycle_price" label="Motorcycle price" placeholder="Enter motorcycle price"
